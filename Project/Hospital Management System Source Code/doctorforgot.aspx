<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="doctorforgot.aspx.vb" Inherits="doctorforgot" Title="Untitled Page" %>
...
<%--<asp:Image ID="Image1" runat="server" style="z-index: 100; left: 116px; position: absolute; top: 277px" Height="250px" ImageUrl="~/pics/forgot_pass[1].jpg" Width="250px" />--%>
    ...
    <table style="z-index: 101; left: 488px; position: absolute; top: 346px;  font-family: 'Lucida Console';">
