<%@ Page Language="VB" Debug ="true"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ipregister.aspx.vb" Inherits="ipregister" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="z-index: 102; left: 168px; font-family: 'Lucida Console'; position: absolute;
        top: 232px">
        <tr>
            <td style="width: 135px">
                <span style=" font-family: Lucida Console">Patientname:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></td>
            <td style="width: 100px">
                <span style=" font-family: Lucida Console">AdmissionID:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="TextBox8" runat="server" Enabled="false"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 135px">
                <span style="font-size: 11pt;  font-family: Lucida Console">Patient ID:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="TextBox2" runat="server" Enabled="false"></asp:TextBox></td>
            <td style="width: 100px">
                <span style=" font-family: Lucida Console">AdmissionDate:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="TextBox9" runat="server" ></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 135px">
                <span style=" font-family: Lucida Console">Gender:</span></td>
            <td style="width: 100px">
            ...
            <td style="width: 100px">
                <span style=" font-family: Lucida Console">AdmissionTime:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="TextBox10" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 135px; height: 26px">
                <span style=" font-family: Lucida Console">Age:</span></td>
            <td style="width: 100px; height: 26px">
                <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox></td>
            <td style="width: 100px; height: 26px">
                <span style=" font-family: Lucida Console">Status:</span></td>
        ...
        <tr>
            <td style="width: 135px">
                <span style=" font-family: Lucida Console">Address:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="TextBox4" runat="server" TextMode="MultiLine"></asp:TextBox></td>
            <td style="width: 100px">
                <span style=" font-family: Lucida Console">Symptoms:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="TextBox12" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 135px">
                <span style=" font-family: Lucida Console">Phoneno(resi):</span></td>
            <td style="width: 100px">
        ...
        <tr>
            <td style="width: 135px">
                <span style=" font-family: Lucida Console">Phoneno(mob):</span></td>
            <td style="width: 100px">
        ...
        <tr>
            <td style="width: 135px">
                <span style=" font-family: Lucida Console">Martialstatus:</span></td>
            <td style="width: 100px">
        ...
        <tr>
            <td style="width: 135px">
                <span style=" font-family: Lucida Console">Occupation:</span></td>
            <td style="width: 100px">
