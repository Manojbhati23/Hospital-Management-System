<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="surgeries.aspx.vb" Inherits="surgeries" Title="Untitled Page" %>
...
<table style="width: 306px; z-index: 101; left: 239px; position: absolute; top: 289px;  font-family: 'Lucida Console'; height: 113px;">
<tr>
...
<table style="z-index: 102; left: 289px; position: absolute; top: 485px">
    ...
    <asp:Calendar ID="Calendar1" runat="server" style="z-index: 102; left: 548px;  position: absolute; top: 376px" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" OnSelectionChanged="Calendar1_SelectionChanged" Width="200px">
