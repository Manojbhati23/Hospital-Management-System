<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="medicaltests.aspx.vb" Inherits="medicaltests" Title="Untitled Page" %>
...
<table style="z-index: 102; left: 112px;  font-family: 'Lucida Console'; position: absolute; top: 203px" id="TABLE1">
   <tr>
       <td>
            Patient Type
       </td>
...
<asp:Panel ID="Panel1" runat="server" Height="200px" Width="200px" style="z-index: 103; left: 115px; position: absolute; top: 368px;  font-family: 'Lucida Console';">
   
    <table style=" font-family: 'Lucida Console'; width: 353px;" >
         <tr>
              <td>
                  Blood Group
              </td>
    ...
    <asp:Panel ID="Panel2" runat="server" Height="200px" Width="200px" style="z-index: 104; left: 116px; position: absolute; top: 373px;  font-family: 'Lucida Console';">
