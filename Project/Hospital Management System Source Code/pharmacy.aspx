<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pharmacy.aspx.vb" Inherits="pharmacy" Title="Untitled Page" %>
    ...
    <table style="z-index: 101; left: 469px; position: absolute; top: 258px">
        <tr>
            <td style="width: 149px">
                <span style=" font-family: Lucida Console">PatientvType:</span></td>
        ...
        <tr>
            <td style="width: 149px">
                <span style=" font-family: Lucida Console">PatientID:</span></td>
            <td style="width: 100px">
        ...
        <tr>
            <td style="width: 149px">
                <span style=" font-family: Lucida Console">Department:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="dpt" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 149px">
                <span style=" font-family: Lucida Console">Patient Name:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="ptntname" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 149px">
                <span style=" font-family: Lucida Console">Medicine Used:</span></td>
            <td style="width: 100px">
