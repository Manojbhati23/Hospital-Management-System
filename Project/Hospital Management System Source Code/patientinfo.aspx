<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="patientinfo.aspx.vb" Inherits="patientinfo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="z-index: 101; left: 120px; width: 344px; position: absolute; top: 440px;
        ...
        <tr>
            <td style="width: 262px">
                <span style=" font-family: Lucida Console">Select Type:</span></td>
            <td style="width: 100px">
