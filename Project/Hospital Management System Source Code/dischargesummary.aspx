<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="dischargesummary.aspx.vb" Inherits="dischargesummary" Title="Untitled Page" %>
    ...
    <table style="z-index: 101; left: 360px; position: absolute; top: 224px">
        <tr>
            <td style="width: 171px">
                <span style=" font-family: Lucida Console">Enter Patient ID:</span></td>
        ...
        <tr>
            <td style="width: 171px">
                <span style=" font-family: Lucida Console">Joining Date:</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="TextBox2" Enabled ="false" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 171px">
                <span style=" font-family: Lucida Console">Discharge Date:</span></td>
            <td style="width: 100px">
